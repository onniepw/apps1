...
export default class Reg_Toko extends Component {
  ...
  TokoRegistrationFunction = () =>{
    ...
    fetch('http://ajmspk.pt-dgw.com:3040/module/testrn/reg_toko.php', {
      method: 'POST',
      headers: {
  ...
  // Showing response message coming from server after inserting records.
        ...
        this.props.navigation.navigate('Reg_Pemilik1');
      }).catch((error) => {
        console.error(error);
      });
...
render() {
  const { username, nama, alamat, kota, phone, photo1, photo2, photo3, no_npwp, nama_npwp,
...
AppRegistry.registerComponent("Reg_Toko", () => Reg_Toko);
